...
namespace Snarl.V42
{
	...
	#region SnarlInterface member functions
		...
		/// <returns></returns>
		public Int32 Notify(String classId, String title, String text, Int32? timeout, String icon, MessagePriority? priority)
		{
			// notify?token=<app_token>[&class=<class_id>][&title=<title>][&text=<text>][&timeout=<timeout>]
			//        [&icon=<icon_path>][&priority=<priority>][&ack=<acknowledge>][&password=<password>]
		...
		public Int32 Notify(String classId, String title, String text, Int32? timeout, String icon)
		{
			return Notify(classId, title, text, timeout, icon, null);
		}

		public Int32 Notify(String classId, String title, String text, Int32? timeout)
		{
			return Notify(classId, title, text, timeout, null, null);
		}

		public Int32 Notify(String classId, String title, String text)
		{
			return Notify(classId, title, text, null, null, null);
		}
		...
		/// <returns></returns>
		public Int32 RegisterApp(String signature, String title, String icon, String password, IntPtr hWndReplyTo, Int32 msgReply)
		{
		...
		public Int32 RegisterApp(String signature, String title, String icon, String password)
		{
			return RegisterApp(signature, title, icon, password, IntPtr.Zero, 0);
		}

		public Int32 RegisterApp(String signature, String title, String icon)
		{
			return RegisterApp(signature, title, icon, null, IntPtr.Zero, 0);
		}
