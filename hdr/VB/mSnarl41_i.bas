...
Public Enum SNARL41_APP_FLAGS
    ...
    SNARL41_APP_HAS_ABOUT = 2
    SNARL41_APP_IS_WINDOWLESS = &H8000&
...
Dim hWnd As Long
    ...
    If IsWindow(hWnd) = 0 Then
        mLocalErr = SNARL41_ERROR_NOT_RUNNING
        Exit Function
...
'' */
'
'Public Sub sn41SetAsSnarlApp(ByVal hWndOwner As Long, Optional ByVal Flags As SNARL41_APP_FLAGS = SNARL41_APP_HAS_ABOUT Or SNARL41_APP_HAS_PREFS)
'
...
Public Function sn41Broadcast() As Long
    ...
    sn41Broadcast = RegisterWindowMessage(SNARL41_GLOBAL_MSG)
...
Public Function sn41AppMsg() As Long
    ...
    sn41AppMsg = RegisterWindowMessage(SNARL41_APP_MSG)
