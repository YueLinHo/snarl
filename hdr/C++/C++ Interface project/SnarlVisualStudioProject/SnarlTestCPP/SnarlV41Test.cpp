...
static LPCTSTR APPNAME  = _T("Snarl C++ Test");
...
CSnarlV41Test::CSnarlV41Test(SnarlInterface* s, CSnarlTestHelper* pTestHelper)
...
void CSnarlV41Test::Test1()
{
	...
	pHelper->WriteLine(_T("RegisterApp: %d"), snarl->RegisterApp(APPNAME, _T("C++ test app"), _T(""), NULL, 0, SnarlEnums::AppHasAbout));
...
void CSnarlV41Test::Test2()
{
	...
	pHelper->WriteLine(_T("RegisterApp: %d"), snarl->RegisterApp(APPNAME, _T("C++ test app"), snarlIcon2, NULL, 0, SnarlEnums::AppDefault));
	pHelper->WriteLine(_T("AddClass: %d"), snarl->AddClass(CLASS1, CLASS_DESC1));
	pHelper->WriteLine(_T("AddClass: %d"), snarl->AddClass(CLASS2, CLASS_DESC2));
...
void CSnarlV41Test::Test3()
{
	...
	pHelper->WriteLine(_T("RegisterApp: %d"), snarl->RegisterApp(APPNAME, _T("C++ test app"), NULL, NULL, 0, SnarlEnums::AppDefault));
