...
namespace SnarlExtensions
{
	...
	public class TimeToXmas : ISnarlExtension
	{
		...
		private const String     Release = "1.1";      // Extension version - displayed after extension name in Extensions list
		private const int        Revision = 1;         // Can be any non-zero number 
		private const int        SnarlApiVersion = 41; // Version should be 41 (to indicate V41 API support) 
